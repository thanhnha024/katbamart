...
if(!empty($weiboo_option['facebook']) || !empty($weiboo_option['twitter']) || !empty($weiboo_option['rss']) || !empty($weiboo_option['pinterest']) || !empty($weiboo_option['google']) || !empty($weiboo_option['instagram']) || !empty($weiboo_option['vimeo']) || !empty($weiboo_option['tumblr']) ||  !empty($weiboo_option['youtube'])){
?>
