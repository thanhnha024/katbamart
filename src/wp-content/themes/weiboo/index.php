                                            ...
                                            <?php
                                               if (!empty($weiboo_option['blog-date'])):
                                                   if ($weiboo_option['blog-date'] == 1): ?>
                                                     <li>
                                                       <div class="blog-date">
                                                         <i class="rt-calendar-days"></i> <?php $post_date = get_the_date(); echo esc_attr($post_date);?>
                                                       </div>                                              
                                                     </li>                                                   
                                                   <?php endif;
                                               else:
                                                    ...
                                                    <?php endif; 
                                                endif;  $commnets = get_comments_number( '0', '1', '%' ); ?>  
                                                <li class="comments">
                                                    <i class="rt-comments" aria-hidden="true"></i> 
                                                    <?php if( $commnets == '1'){
                                                        echo esc_html($commnets); echo esc_html__(' Comment','weiboo');
                                                    }  else{
                                                        echo esc_html($commnets); echo esc_html__(' Comments','weiboo');
                                                    } ?>
