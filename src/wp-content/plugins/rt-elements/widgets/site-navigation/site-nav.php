...
class RTS_Navigation_Menu extends Widget_Base {
	...
	protected function register_general_content_controls() {
		...
		$this->add_control(
			'menu_last_item',
			[
				'label'     => __( 'Last Menu Item', 'rtelements' ),
				'type'      => Controls_Manager::SELECT,
				'options'   => [
					'none' => __( 'Default', 'rtelements' ),
					'cta'  => __( 'Button', 'rtelements' ),
				],
				'default'   => 'none',
				'condition' => [
					'layout!' => 'expandible',
		...
		$this->add_control(
			'schema_support',
			[
				'label'        => __( 'Enable Schema Support', 'rtelements' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => __( 'Yes', 'rtelements' ),
				'label_off'    => __( 'No', 'rtelements' ),
				'return_value' => 'yes',
				'default'      => 'no',
		...
		$this->end_controls_section();
			...
			$this->add_control(
				...
				[
					...
					'options' => [
						...
						'expandible' => __( 'Expanded', 'rtelements' ),
						'flyout'     => __( 'Flyout', 'rtelements' ),
					],
				]
			);
			...
			$this->add_control(
				'link_redirect',
				[
					'label'        => __( 'Action On Menu Click', 'rtelements' ),
					'type'         => Controls_Manager::SELECT,
					'default'      => 'child',
					'description'  => __( 'For Horizontal layout, this will affect on the selected breakpoint', 'rtelements' ),
					'options'      => [
						'child'     => __( 'Open Submenu', 'rtelements' ),
						'self_link' => __( 'Redirect To Self Link', 'rtelements' ),
					],
			...
			$this->add_control(
				...
				[
					...
					'label'     => __( 'Responsive', 'rtelements' ),
					'separator' => 'before',
					'condition' => [
						'layout' => [ 'horizontal', 'vertical' ],
					],
		...
		$this->add_control(
			'dropdown',
			[
				'label'        => __( 'Breakpoint', 'rtelements' ),
				'type'         => Controls_Manager::SELECT,
				'default'      => 'tablet',
				'options'      => [
					'mobile' => __( 'Mobile (768px >)', 'rtelements' ),
					'tablet' => __( 'Tablet (1025px >)', 'rtelements' ),
		...
		$this->add_control(
			...
			[
				...
				'default'              => 'center',
				'description'          => __( 'This is the alignement of menu icon on selected responsive breakpoints.', 'rtelements' ),
				'condition'            => [
					'layout'    => [ 'horizontal', 'vertical' ],
					'dropdown!' => 'none',
				],
		...
		$this->add_control(
			'full_width_dropdown',
			[
				'label'        => __( 'Full Width', 'rtelements' ),
				'description'  => __( 'Enable this option to stretch the Sub Menu to Full Width.', 'rtelements' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => __( 'Yes', 'rtelements' ),
				'label_off'    => __( 'No', 'rtelements' ),
				'return_value' => 'yes',
	...
	protected function register_style_content_controls() {
		...
		$this->add_control(
			'animation_framed',
			[
				'label'     => __( 'Frame Animation', 'rtelements' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'fade',
				'options'   => [
					'fade'    => 'Fade',
		...
		$this->start_controls_tabs( 'tabs_menu_item_style' );
				...
				$this->start_controls_tab(
					...
					$this->add_control(
						...
						[
							'label'     => __( 'Link Hover Effect Color', 'rtelements' ),
							'type'      => Controls_Manager::COLOR,
							'global'    => [
								'default' => Global_Colors::COLOR_ACCENT,
							],
	...
	protected function register_dropdown_content_controls() {
		...
		$this->add_responsive_control(
			'close_flyout_size',
			[
				'label'              => __( 'Close Icon Size', 'rtelements' ),
				'type'               => Controls_Manager::SLIDER,
				'range'              => [
					'px' => [
						'min' => 15,
