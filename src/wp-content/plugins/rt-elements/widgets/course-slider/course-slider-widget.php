...
class Rsaddon_Elementor_Course_Slider_Pro_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'RS Course Slider', 'rsaddon' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'author_settings',
			[
				'label' => esc_html__( 'Author Settings', 'rsaddon' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .courses-item .content-part .meta-part li.user' => 'color: {{VALUE}};',
                ],
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .course-slider-style3 .courses-item .content-part .meta-part' => 'color: {{VALUE}};',
                ],
                'condition' => [
                    'course_slider_style' => 'style3',
                ],                
        ...
        $this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Typography', 'rsaddon' ),
				'scheme' => Scheme_Typography::TYPOGRAPHY_1,
				'selector' => '{{WRAPPER}} .courses-item .content-part .meta-part',
				'condition' => [
				    'course_slider_style' => 'style1',
				],
			]
        ...
        $this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name' => 'meta_typography2',
				'label' => esc_html__( 'Typography', 'rsaddon' ),
				'scheme' => Scheme_Typography::TYPOGRAPHY_1,
				'selector' => '{{WRAPPER}} .courses-item .content-part .meta-part li.user',
				'condition' => [
				    'course_slider_style' => 'style2',
				],
			]
        ...
        $this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name' => 'meta_typography3',
				'label' => esc_html__( 'Typography', 'rsaddon' ),
				'scheme' => Scheme_Typography::TYPOGRAPHY_1,
				'selector' => '{{WRAPPER}} .course-slider-style3 .courses-item .content-part .meta-part',
				'condition' => [
				    'course_slider_style' => 'style3',
				],
			]
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .courses-item .content-part .meta-part' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
		...
		$this->start_controls_section(
			'author_style',
			[
				'label' => esc_html__( 'Author Style', 'rsaddon' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .courses-item .author-name a' => 'color: {{VALUE}};',
                ],                
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .courses-item .course-author:hover .author-name a' => 'color: {{VALUE}};',
                ],                
            ]
        );
        ...
        $this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Typography', 'rsaddon' ),
				'scheme' => Scheme_Typography::TYPOGRAPHY_1,
				'selector' => '{{WRAPPER}} .courses-item .author-name a',
			]
		);
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .courses-item .author-img img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .courses-item .course-author' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .courses-item .content-part .bottom-part' => 'margin-top: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .courses-item .content-part .bottom-part' => 'border-color: {{VALUE}};',
                ],
                'condition' => [
                    'course_slider_style' => 'style2',
                ],                
		...
		$this->start_controls_section(
			'ratings_style',
			[
				'label' => esc_html__( 'Ratings Style', 'rsaddon' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .course-ratings .fa-star, {{WRAPPER}} .course-ratings .review-stars-rated .review-stars.empty, {{WRAPPER}} .course-ratings .review-stars-rated .review-stars.filled' => 'color: {{VALUE}};',
                ],                
            ]
        );
        ...
        $this->add_control(
            'count_color',
            [
                'label' => esc_html__( 'Count Color', 'rsaddon' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
