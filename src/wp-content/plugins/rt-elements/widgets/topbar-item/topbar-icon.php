...
class RTS_Topbar_Icon_List_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Topbar Icon list', 'rsaddon' );
    }
	...
	protected function register_controls() {
        ...
        $repeater->add_control(
            'icon-color',
            [
                'label' => esc_html__( 'Icon BG', 'rsaddon' ),
                'type' => Controls_Manager::COLOR,
                 'selectors' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [   
                        'text' => esc_html__( '890.234.112', 'rsaddon' ),
                        'icon' => 'fas fa-phone',
                    ],
                    [
                        'text' => esc_html__( 'info@webmail.com', 'rsaddon' ),
                    ...
                    <ul class="rt-features-list">
                        <?php foreach ( $settings['features_list'] as $index => $feature ) :
                            ...
                            <li class="<?php echo esc_attr( 'elementor-repeater-item-' . $feature['_id'] ); ?>">
                                <?php if ( $feature['icon'] ) : ?>
                                    <div class="icon"><i class="<?php echo esc_attr( $feature['icon'] ); ?>"></i></div>
                                    
                                <?php endif; ?>
                                <div class="query-list">
                                    <span class="sub-text"><?php echo wp_kses_post( $feature['sub-text'] ); ?></span>
                                    <span class="text-heading"><?php echo wp_kses_post( $feature['text'] ); ?></span>
                                </div>
