...
class Rsaddon_Elementor_prold_Course_Category_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Educavo LearnDash Category', 'rsaddon' );
	}
				            ...
				            echo '<div class="col-lg-4 col-md-6">
				            	<a class="categories-item" href="'.$term_link.'">
	                                    ...
	                                    <div class="content-part">
	                                        ...
	                                        <span class="courses">'.$n.' '.$course_valu.'</span>
	                                    </div>
	                                </a>
				        	</div>';			        	
					    } 
