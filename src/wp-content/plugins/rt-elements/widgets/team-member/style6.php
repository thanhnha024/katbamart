					...
					<div class="team-item">
						<div class="team-inner-wrap">
							<div class="image-wrap">
								<a class="pointer-events" href="#rs_popupBox6_<?php echo esc_attr($x);?>" data-effect="mfp-zoom-in">
									<?php the_post_thumbnail($settings['thumbnail_size']); ?>
								</a>
								  
							</div>	
							<div class="team-content">
							  <h3 class="team-name"><a class="pointer-events" href="#rs_popupBox6_<?php echo esc_attr($x);?>" data-effect="mfp-zoom-in"><?php the_title();?></a></h3>
