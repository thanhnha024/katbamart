<div class="rs-team-grid rs-team team-grid-<?php echo esc_html($settings['team_grid_style']); ?> <?php echo esc_html($settings['team_grid_popup']);?> rsaddon_pro_box">
	<div class="row">
		 	<?php //******************//
					...
					<div class="team-item">
						<div class="team-inner-wrap">
							<div class="image-wrap">
								<a class="pointer-events" href="#rs_popupBox5_<?php echo esc_attr($x);?>" data-effect="mfp-zoom-in">
									<?php the_post_thumbnail($settings['thumbnail_size']); ?>
								</a>   
							</div>	
							<div class="team-content">
								<div class="member-desc">
									<h3 class="team-name"><a class="pointer-events" href="#rs_popupBox5_<?php echo esc_attr($x);?>" data-effect="mfp-zoom-in"><?php the_title();?></a></h3>
				...
				<div id="rs_popupBox5_<?php echo esc_attr($x);?>" class="rspopup_style1   mfp-with-anim mfp-hide" <?php echo wp_kses_post($popup_background);?>>
					<div class="row">
						<div class="col-md-5">
