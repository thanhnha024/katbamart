...
<div data-rating="<?php echo $arating; ?>" data-sell="<?php echo $price; ?>" class="element-item col-xxl-<?php echo esc_html($settings['product_columns']);?> col-xl-3 col-lg-4 col-sm-6 col-xs-1 grid-item <?php echo $filter_class;?> p-0">
	<div class="product-item content-overlay">
			<?php if(has_post_thumbnail()): ?>
				<div class="product-img<?php echo esc_attr($star_align); ?>">
					...
					if(empty($gallery)){
						...
						<?php
						if( !empty($p2ndImg) ){
							$img2_link = wp_get_attachment_image_src( $p2ndImg, $img_size)[0];
							?>
						...
						<div class="product-image--slider">
							<div class="swiper-wrapper">
								...
								foreach( $gallery as $pimage ){
									$link = wp_get_attachment_image_src($pimage, $img_size);
									?>
			...
			<?php endif;?>
			<div class="product-content<?php echo esc_attr($align_class); ?> rselements-product-list">
