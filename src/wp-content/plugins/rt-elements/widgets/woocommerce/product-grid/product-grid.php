...
class Rsaddon_Elementor_Pro_Product_Grid_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'RT Product List', 'rsaddon' );
	}
	...
	protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
					...
					'20p' => esc_html__( '5 Column', 'rsaddon' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#272727',
                'selectors' => [
                    '{{WRAPPER}} .rt-product--grid h4 a' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .rt-product--grid h4 a',
            ]
        );
    ...
    protected function render(){
        ...
        $pstyle = $settings['rs_product_grid_style_preset'];
        global $weiboo_option;

        $repeat_style  = '';
        if( $pstyle == '6' ) $repeat_style = ' rtpg-style2';

        ?>
        <div class="row rt-product--grid rtpg-style<?php echo esc_attr($pstyle);?><?php echo esc_attr($repeat_style);?>">
            <?php         	
                if($pstyle){
                    require plugin_dir_path(__FILE__)."style$pstyle.php";
                }else{
