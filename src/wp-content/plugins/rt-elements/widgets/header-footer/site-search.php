    ...
    protected function register_search_style_controls() {
        ...
        $this->add_responsive_control(
         ...
         $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .rts-search-button-wrapper .sticky_search' => 'width: {{SIZE}}{{UNIT}};',
          ...
          $this->add_control(
            ...
            [
                ...
                'selectors' => [                    
                    '{{WRAPPER}} .rts-search-button-wrapper .sticky_search' => 'height: {{SIZE}}{{UNIT}};',
           ...
           $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .rts-search-button-wrapper .sticky_search' => 'line-height: {{SIZE}}{{UNIT}};'
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'types' => [ 'classic', 'gradient' ],
                'selector' => '.rts-search-button-wrapper .sticky_search',
            ]
        );   
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%' ],
                'selectors' => [
                    '.rts-search-button-wrapper .sticky_search' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
