    ...
    <div class="services-part">
	    ...
	    <div class="services-text style5">
	    	...
	    	<?php if(!empty($settings['text'])) : ?>
	    		<div <?php  echo wp_kses_post($this->print_render_attribute_string( 'text' )); ?>>  <?php echo wp_kses_post($settings['text']);?></div>	
	    	<?php endif; ?>	
	    	...
	    	<?php } ?>
	    		<?php if( !empty($settings['title_prefix_number'])){?>
	    	    	<div class="shadow-text"><?php echo esc_html($settings['title_prefix_number']);?></div>
	    	    <?php } ?>
