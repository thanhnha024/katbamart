...
class Jet_Search_Ajax_Search_Widget extends Jet_Search_Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'RT Ajax Search', 'jet-search' );
	}
	...
	public function get_categories() {
		return array( 'pielements_category' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'type'  => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .jet-ajax-search__categories-select-icon i' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			array(
				'name'     => 'search_category_icon_typography',
				'selector' => '{{WRAPPER}} .jet-ajax-search__categories-select-icon i',
			)
		);
	...
	public function add_meta_controls( $position_slug, $position_name ) {
		...
		$repeater->add_control(
			...
			array(
				...
				'type'    => Controls_Manager::SELECT,
				'default' => '',
				'options' => apply_filters( 'jet-search/ajax-search/meta_callbacks', array(
